    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('business_hours_from') ?></th>
                <th scope="col"><?= $this->Paginator->sort('business_hours_to') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= h($shopInfo->business_hours_from) ?></td>
                <td><?= h($shopInfo->business_hours_to) ?></td>
